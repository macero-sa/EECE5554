...
static const _GpsMsg_type_support_symbol_names_t _GpsMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gps_message, msg, GpsMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gps_message, msg, GpsMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gps_message, msg, GpsMsg)() {
  return &::gps_message::msg::rosidl_typesupport_c::GpsMsg_message_type_support_handle;
}
