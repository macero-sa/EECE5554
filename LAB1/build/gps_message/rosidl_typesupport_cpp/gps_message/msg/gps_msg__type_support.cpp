...
static const _GpsMsg_type_support_symbol_names_t _GpsMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gps_message, msg, GpsMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gps_message, msg, GpsMsg)),
  }
};
...
get_message_type_support_handle<gps_message::msg::GpsMsg>()
{
  return &::gps_message::msg::rosidl_typesupport_cpp::GpsMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gps_message, msg, GpsMsg)() {
  return get_message_type_support_handle<gps_message::msg::GpsMsg>();
}
