...
#include "gps_message/msg/detail/gps_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "gps_message/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "rosidl_runtime_c/string.h"  // letter, utc_time
#include "rosidl_runtime_c/string_functions.h"  // letter, utc_time
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_gps_message
...
using _GpsMsg__ros_msg_type = gps_message__msg__GpsMsg;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gps_message
size_t get_serialized_size_gps_message__msg__GpsMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GpsMsg__ros_msg_type * ros_message = static_cast<const _GpsMsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GpsMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gps_message__msg__GpsMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gps_message
size_t max_serialized_size_gps_message__msg__GpsMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gps_message__msg__GpsMsg;
    is_plain =
      (
...
static size_t _GpsMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gps_message__msg__GpsMsg(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gps_message, msg, GpsMsg)() {
