...
static const _ImuMsg_type_support_symbol_names_t _ImuMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imu_msg, msg, ImuMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, imu_msg, msg, ImuMsg)),
  }
};
...
{
  return &::imu_msg::msg::rosidl_typesupport_cpp::ImuMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, imu_msg, msg, ImuMsg)() {
  return get_message_type_support_handle<imu_msg::msg::ImuMsg>();
}
