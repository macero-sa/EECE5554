...
{
  new (message_memory) imu_msg::msg::ImuMsg(_init);
}

void ImuMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<imu_msg::msg::ImuMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ImuMsg_message_member_array[4] = {
  {
    ...
    offsetof(imu_msg::msg::ImuMsg, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(imu_msg::msg::ImuMsg, imu),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(imu_msg::msg::ImuMsg, mag_field),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(imu_msg::msg::ImuMsg, raw_data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ImuMsg_message_members = {
  "imu_msg::msg",  // message namespace
  "ImuMsg",  // message name
  4,  // number of fields
  sizeof(imu_msg::msg::ImuMsg),
...
get_message_type_support_handle<imu_msg::msg::ImuMsg>()
{
  return &::imu_msg::msg::rosidl_typesupport_introspection_cpp::ImuMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, imu_msg, msg, ImuMsg)() {
  return &::imu_msg::msg::rosidl_typesupport_introspection_cpp::ImuMsg_message_type_support_handle;
}
