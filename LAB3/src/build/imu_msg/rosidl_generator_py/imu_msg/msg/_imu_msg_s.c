...
bool imu_msg__msg__imu_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imu_msg.msg._imu_msg.ImuMsg", full_classname_dest, 27) == 0);
  }
  imu_msg__msg__ImuMsg * ros_message = _ros_message;
  {  // header
...
PyObject * imu_msg__msg__imu_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("imu_msg.msg._imu_msg");
