...
#include "imu_msg/msg/detail/imu_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_imu_msg
cdr_serialize(
  const imu_msg::msg::ImuMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  imu_msg::msg::ImuMsg & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = imu_msg::msg::ImuMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const imu_msg::msg::ImuMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<imu_msg::msg::ImuMsg *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_imu_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<imu_msg::msg::ImuMsg>()
{
  return &imu_msg::msg::typesupport_fastrtps_cpp::_ImuMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imu_msg, msg, ImuMsg)() {
  return &imu_msg::msg::typesupport_fastrtps_cpp::_ImuMsg__handle;
}
