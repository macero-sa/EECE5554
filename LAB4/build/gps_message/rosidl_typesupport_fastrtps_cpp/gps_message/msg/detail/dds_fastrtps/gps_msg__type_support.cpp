...
#include "gps_message/msg/detail/gps_msg__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gps_message::msg::GpsMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gps_message::msg::GpsMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gps_message::msg::GpsMsg *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_gps_message
const rosidl_message_type_support_t *
get_message_type_support_handle<gps_message::msg::GpsMsg>()
{
  return &gps_message::msg::typesupport_fastrtps_cpp::_GpsMsg__handle;
}
