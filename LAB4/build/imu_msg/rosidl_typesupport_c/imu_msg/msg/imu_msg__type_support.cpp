...
static const _ImuMsg_type_support_symbol_names_t _ImuMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, imu_msg, msg, ImuMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, imu_msg, msg, ImuMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, imu_msg, msg, ImuMsg)() {
  return &::imu_msg::msg::rosidl_typesupport_c::ImuMsg_message_type_support_handle;
}
