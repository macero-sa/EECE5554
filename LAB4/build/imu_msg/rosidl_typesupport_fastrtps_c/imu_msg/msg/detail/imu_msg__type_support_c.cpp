...
#include "imu_msg/msg/detail/imu_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "imu_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "rosidl_runtime_c/string.h"  // raw_data
#include "rosidl_runtime_c/string_functions.h"  // raw_data
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_imu_msg
...
using _ImuMsg__ros_msg_type = imu_msg__msg__ImuMsg;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_imu_msg
size_t get_serialized_size_imu_msg__msg__ImuMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ImuMsg__ros_msg_type * ros_message = static_cast<const _ImuMsg__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ImuMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_imu_msg__msg__ImuMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_imu_msg
size_t max_serialized_size_imu_msg__msg__ImuMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = imu_msg__msg__ImuMsg;
    is_plain =
      (
...
static size_t _ImuMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_imu_msg__msg__ImuMsg(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, imu_msg, msg, ImuMsg)() {
