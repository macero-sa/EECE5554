...
bool gps_message__msg__gps_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gps_message.msg._gps_msg.GpsMsg", full_classname_dest, 31) == 0);
  }
  gps_message__msg__GpsMsg * ros_message = _ros_message;
  {  // header
...
PyObject * gps_message__msg__gps_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gps_message.msg._gps_msg");
